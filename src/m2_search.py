...
class BM25Search:
    ...
    def index(self, chunks: list[dict]) -> None:
        ...
        corpus_tokens = [segment_vietnamese(c["text"]).split() for c in chunks]
...
class DenseSearch:
    def __init__(self):
        ...
        try:
            ...
            print("  WARNING: Qdrant server not found, using :memory: mode")
    ...
    def search(self, query: str, top_k: int = DENSE_TOP_K, collection: str = COLLECTION_NAME) -> list[SearchResult]:
        ...
        # Use query_points for newer versions, fallback to search for older
        try:
